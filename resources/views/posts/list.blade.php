...
@section('content')
    <div class="content">
        ...
        <div class="my-4" id="tableExample" data-list="{&quot;valueNames&quot;:[&quot;name&quot;,&quot;email&quot;,&quot;age&quot;],&quot;page&quot;:15}">
            <div class="table-responsive scrollbar">
                <table class="table table-bordered table-striped fs--1 mb-0">
                    ...
                    <tr>
                        ...
                        <th class="sort" data-sort=" ">Num. Of Views</th>
                    ...
                    @foreach($posts as $post)
                        <tr>
                            ...
                            <td class="email">{{ $post->num_of_views }}</td>
